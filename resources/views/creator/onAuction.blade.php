        ...
        <div class="w3-responsive w3-card-4">
            ...
            <tbody>
              ...
              <form class="w3-container" action="/nft/add/{{$auction->id}}/{{$auction->creation_id}}" method="post" enctype="multipart/form-data">
                ...
                <td>
                  <a href="/creator/auction/{{$auction->id}}/edit"  class="btn btn-primary">Edit </a>
                  <a  href="/creator/auction/{{$auction->id}}/delete" class="btn btn-danger">Delete </a>
                </td>
