...
<head>
    ...
    <title>Sell Creations</title>
</head>
<body>
    @include('includes.nav')
    <div style="margin: 5%">
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2> Send Creation to Auction</h2>
        <form class="w3-container" action="/creator/{{session('userid')}}/creation/send" method="post" enctype="multipart/form-data">
          @csrf
          <div>
            <label>Title</label>
          ...
          <div>
          <label>Edition</label>
          <input class="w3-input w3-border w3-hover-border-black" style="width:100%;" type="text" name="edition"  required>
          </div>
          <br>
          <div>
            <label>Type</label>
          ...
          <br>
          <button type="submit" class="w3-button w3-block w3-black">Send</button><br>
        </form>
        @if (isset($errors))
